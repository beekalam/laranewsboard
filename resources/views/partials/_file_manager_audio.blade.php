        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div class="file-manager-search">
                    <input type="text" id="input_search_audio" class="form-control"
                    ...
                    <div class="file-manager-left">
                        ...
                        <div id="add_audio_form">
                            <div class="form-group">
                                <label class="control-label">@lang('messages.audio_name'); ?></label>
                                <input type="text" id="audio_name" class="form-control"
                                       placeholder="@lang('messages.audio_name'); ?>">
                            </div>

                            <div class="form-group">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <label class="control-label">@lang('messages.musician'); ?></label>
                                        <input type="text" id="musician" class="form-control"
                                               placeholder="@lang('messages.musician'); ?>" >
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <label>@lang('messages.download_button'); ?></label>
                                    </div>
                                    <div class="col-sm-6">
                                        ...
                                        <label for="rb_download_button_1"
                                               class="cursor-pointer">@lang('messages.show'); ?></label>
                                    </div>
                                    <div class="col-sm-6">
                                        ...
                                        <label for="rb_download_button_2"
                                               class="cursor-pointer">@lang('messages.hide'); ?></label>
                                    </div>
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="control-label">@lang('messages.audio_file'); ?></label>
                                <div class="row">
                                    <div class="col-sm-12 m-b-10">
                                        <a class='btn btn-sm bg-olive'>
                                            ...
                                            <input type="file" id="audio_file_input" name="file"
                                                   ...
                                                   onchange="$('#input_audio_file_label').html($(this).val().replace(/.*[\/\\]/, '..'));">
                                        </a>
                                    </div>
                                    <div class="col-sm-12">
                            ...
                            <div id="audio_file_upload_response">
                                ...
                                <div class="col-sm-2 col-file-manager" id="audio_col_id_<?php echo $audio->id; ?>">
                                    <div class="file-box" data-file-id="<?php echo $audio->id; ?>">
                                        <img src="<?php echo base_url(); ?>assets/admin/img/music-file.png" alt=""
                                             class="img-responsive file-icon">
                                        <p class="file-manager-list-item-name"
                                           title="<?php echo $audio->musician . " - " . $audio->audio_name; ?>"><?php echo character_limiter($audio->musician . " - " . $audio->audio_name, 18, '...'); ?></p>
                                    </div>
                                </div>
            ...
            <div class="modal-footer">
                <div class="file-manager-footer">
                    <button type="button" id="btn_audio_delete" class="btn btn-danger pull-left btn-file-delete"><i
                                class="fa fa-trash"></i>&nbsp;&nbsp;@lang('messages.delete'); ?></button>
                    <button type="button" id="btn_audio_select" class="btn bg-olive btn-file-select"><i
                                class="fa fa-check"></i>&nbsp;&nbsp;@lang('messages.select_audio'); ?></button>
